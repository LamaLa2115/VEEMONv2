import { EnhancedDiscordBot } from './enhanced-discord-bot';
...
// Use the enhanced bot instead of the basic one
const enhancedBot = new EnhancedDiscordBot();

// Export wrapper to maintain compatibility with existing code
export const discordBot = {
  start: () => enhancedBot.start(),
  getClient: () => enhancedBot.getClient(),
  getCommands: () => enhancedBot.getCommands()
};
